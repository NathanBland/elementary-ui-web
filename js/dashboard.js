...
buf.push("</i>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 16, "dashboard.jade" ));
buf.push("Edit");
jade_debug.shift();
jade_debug.shift();
buf.push("</button>");
...
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 22, "dashboard.jade" ));
buf.push("<p>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</p>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 23, "dashboard.jade" ));
buf.push("<p>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 23, jade_debug[0].filename ));
buf.push("Why not ");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 24, "dashboard.jade" ));
buf.push("<a>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</a>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 25, "dashboard.jade" ));
buf.push("a few?");
jade_debug.shift();
jade_debug.shift();
buf.push("</p>");
