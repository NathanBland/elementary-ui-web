...
buf.push("<div class=\"note__card mdl-card mdl-shadow--4dp animated tada\">");
...
buf.push("</i>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 9, "note.jade" ));
buf.push("Edit");
jade_debug.shift();
jade_debug.shift();
buf.push("</button>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 10, "note.jade" ));
...
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 11, "note.jade" ));
buf.push("<i class=\"material-icons\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</i>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 12, "note.jade" ));
buf.push("Delete");
jade_debug.shift();
jade_debug.shift();
buf.push("</button>");
